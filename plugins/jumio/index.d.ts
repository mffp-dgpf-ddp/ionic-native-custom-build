...
export declare class JumioNetverifyConfig {
    /**
...
export declare class JumioDocVerificationConfig {
    /**
...
declare class JumioAuthenticationConfig {
    /**
...
export declare class NetverifyDocumentData {
    /**
...
export declare class BAMCardInformation {
    /**
 ...
 * ```
 */
export declare class JumioOriginal extends IonicNativePlugin {
    /**
     ...
     * @return Returns a promise that resolves when something happens
     */
    initDocumentVerification(apiToken: string, apiSecret: string, dataCenter: string, docVerificationConfig: JumioDocVerificationConfig): Promise<any>;
    /**
     ...
     * @return Returns a promise that resolves when something happens
     */
    initAuthentication(apiToken: string, apiSecret: string, dataCenter: string, authenticationConfig: JumioAuthenticationConfig): Promise<any>;
    /**
...
export declare const Jumio: JumioOriginal;